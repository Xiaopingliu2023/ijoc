...
set.seed(94,"Mersenne-Twister",sample.kind="Rejection")
...
myout<-show_out(Table010,"friday_output10.xlsx")
my_out(Table010,"friday_output10.xlsx")
...
write_xlsx(myout, "Friday_output10.xlsx")
