...
Table010[,6]<-Table010[,6]/10+0.1
Table010<-Table010/1.01
Table010[,6]<-Table010[,6]+1
Table010[,7]<-Table010[,7]+0.1
myout<-show_out(Table010,"Friday_output05.xlsx")
my_out(Table010,"Friday_output05.xlsx")
...
colnames(myout) <- c("100", "200","300","400","500")
myout$Method<-NA
mt<-c("Random","Stratified","KD-NoModel","BDMW","BDMX","GSPW","GSPX")
for(i in 0:6){
...
write_xlsx(myout, "Friday_output05.xlsx")
