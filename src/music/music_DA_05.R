...
set.seed(91,"Mersenne-Twister",sample.kind="Rejection")
...
myout<-show_out(Table010,"music_output05.xlsx")
#my_out(Table010,"music_output05.xlsx")
...
write_xlsx(myout, "music_output05.xlsx")
